...
docker save -o ${DOCKER_IMG_DIR}git.lab%2Flab%2Fdnsmasq_svc%3Astage.dockerimage git.lab/lab/dnsmasq_svc:stage
docker compose build caddy_certs_init # builds git.lab/lab/caddy_certs_init:stage
docker save -o ${DOCKER_IMG_DIR}git.lab%2Flab%2Fcaddy_certs_init%3Astage.dockerimage git.lab/lab/caddy_certs_init:stage
docker compose build caddy_rproxy # builds git.lab/lab/caddy_rproxy:stage
docker save -o ${DOCKER_IMG_DIR}git.lab%2Flab%2Fcaddy_rproxy%3Astage.dockerimage git.lab/lab/caddy_rproxy:stage
docker compose down
