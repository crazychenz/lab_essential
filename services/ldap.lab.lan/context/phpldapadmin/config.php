...
// Each new use of an environment variable needs an entry in www.conf.
$servers->newServer('ldap_pla');
$servers->setValue('server','name',env('LDAP_NAME', 'LDAP Server'));
$servers->setValue('server','host',env('LDAP_HOST', '127.0.0.1'));
$servers->setValue('server','port',env('LDAP_PORT', '389'));
$servers->setValue('server','base',array(env('LDAP_BASE', 'dc=example,dc=org')));
